 ...
 */
@RestController
@RequestMapping("lpmallware/purchasedetail")
public class PurchaseDetailController {
    ...
    //@RequiresPermissions("lpmallware:purchasedetail:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("lpmallware:purchasedetail:save")
    ...
    //@RequiresPermissions("lpmallware:purchasedetail:update")
    ...
    //@RequiresPermissions("lpmallware:purchasedetail:delete")
